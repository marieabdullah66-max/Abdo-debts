...
const state = {
  ...
  reportBuilderAchievements:'', reportBuilderPlan:'', reportBuilderPreparedBy:'', reportBuilder: null,
...
function reportBuilderView(main){
  ...
  <section class="panel report-builder-manual"><div class="field"><label>الأشياء المنجزة خلال الفترة (يدوي)</label><textarea class="textarea" id="reportAchievements" placeholder="اكتب الإنجازات...">${esc(state.reportBuilderAchievements)}</textarea></div><div class="field"><label>خطة الفترة القادمة (يدوي)</label><textarea class="textarea" id="reportPlan" placeholder="اكتب الخطة القادمة...">${esc(state.reportBuilderPlan)}</textarea></div><div class="field"><label>مُعد التقرير (يدوي)</label><input class="input" id="reportPreparedBy" value="${esc(state.reportBuilderPreparedBy)}" placeholder="اسم معد التقرير"></div></section>
