...
async function renderMovementAnalysis(box){
  ...
  <section class="movement-filter-panel"><div class="movement-filters"><div class="field"><label>الفرع</label><select class="select" id="movementBranchFilter"><option value="">كل الفروع</option>${branchOptions(false,false)}</select></div><div class="field"><label>التقرير</label><select class="select" id="movementReportSelect"><option value="">جاري تحميل التقارير...</option></select></div><div class="field"><label>الحالة</label><select class="select" id="movementStatusFilter"><option value="all">كل الأصناف</option><option value="unmatched">تحتاج مطابقة</option><option value="blocking">غير محسوبة بسبب الفرط</option></select></div><div class="field"><label>ABC</label><select class="select" id="movementAbcFilter"><option value="all">كل ABC</option><option value="A">A - الأصناف الأهم</option><option value="B">B - متوسطة</option><option value="C">C - قليلة</option></select></div><div class="field"><label>ترتيب معدل البيع</label><select class="select" id="movementSortFilter"><option value="desc">الأعلى إلى الأقل</option><option value="asc">الأقل إلى الأعلى</option></select></div></div><div class="toolbar movement-search-toolbar"><input class="input" id="movementSearch" value="${esc(state.movementSearch)}" placeholder="بحث باسم الصنف أو الكود..."></div></section>
...
function movementAbcText(){return ({all:'كل ABC',A:'A - الأصناف الأهم',B:'B - متوسطة',C:'C - قليلة'})[state.movementAbc||'all']||'كل ABC';}
